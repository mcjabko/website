  ...
  return (
    ...
    >
      ...
      <ol>
        ...
        <ol>
          <li>
            To znamená že je nepřípustné jakkoliv napadat, cílené zpomalovat,
            narušovat provoz, či jinak ovlivňovat chod infrastruktury serveru,
            DDOs útoky, neoprávněnými přístupy, stavbou cíleně nákladných staveb
            na výkon serveru přímo vně serveru, nebo jinými fyzickými nebo
            logickými způsoby.
          </li>
          <li>
            Pokud člen Admin teamu usoudí že stavba hráče narušuje chod serveru,
            je oprávněn ji zničit.
          </li>
        </ol>
        <li>
          ...
          válečné zločiny a jakékoliv protiprávní jednání v rámci zákonů České a
          Slovenské republiky!
        </li>
        ...
        <ol>
          <li>
            ...
            zodpovídá jeho uživatel za dostatečně silné heslo, za jakékoliv akce
            provedené prostřednictvím tohoto účtu.
          </li>
          <li>
            Každý uživatel má právo vlastnit jen a pouze jeden uživatelský účet
            vázaný na jeho IP adresu, výjimkou je sdílená domácnost s členem
            rodiny či duplicitní IP adresa v rámci poskytovatele internetu, v
            případě připojení jiného účtu na stejné IP adrese na které byl
            uložen ban je Admin team v případech, kdy je pravděpodobné že se
            jedná o obcházení banu, oprávněn uložit permanentní IP ban a
            uživatel musí doložit důkaz o opaku.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            Pokud hráč usoudí, že člen Admin teamu jedná v rozporu s pravidly a
            je zjevné že není ani oprávněn jednat dle pravidla je oprávněn jej
            nahlásit vyšší funkci, nebo pomocí ticketu, kdy bude s daným členem
            Admin teamu zahájeno šetření a dokazování skutečností, pokud se
            Admin team jako celek shodne na tom že daný člen Admin teamu jednal
            v rozporu s pravidly, bude náležitě potrestán či zbaven funkce.
          </li>
        </ol>
        <li>
        ...
        <ol>
          <li>
            ...
            součásti konverzace! Náhodné vykřikování sprostých slov či urážek
            nebude tolerováno!
          </li>
        </ol>
        <li>
          Je zakázáno jakkoli slovně napadat, urážet či jinak útočit na ostatní
          hráče a členy A-teamu!
        </li>
        <li>
        ...
        <li>
          Je zakázáno využívat veškerých bugů (a podobné jako clay bug)! Hráč je
          povinen takový bug bezodkladně nahlásit členovi A-teamu!
        </li>
        <li>
          Je zakázáno jakkoliv zpomalovat server pomocí nadměrného chovu zvířat
          v takovém stylu, kdy se jejich hitboxy protínají, stavbou tzv. „Lag
          Machines“, létajícími stroji, podpalování lesů, přehnaně velkými
          farmami atd.! Třídičky nesmí překročit 10 třídících členů na chunk!
        </li>
        <li>
          Server neručí za ztracené věci vlivem teleportace na jiného hráče,
          chybou hráče, lagem hry na straně clienta či výpadkem připojení daného
          hráče.
        </li>
        <ol>
          <li>
            Výjimkou je chyba na straně serveru či při ztrátě při teleportaci za
            cílem obchodu!
          </li>
        </ol>
        ...
        <li>
          Je zakázáno jakkoli propagovat, tvořit reklamu, nabádat a doporučovat
          jiné minecraft servery, discord servery, nebo jakékoliv jiné produkty
          prostřednictvím serveru, či discord serveru.
        </li>
        <li>
        ...
        <li>
          Admin Team má právo hráči, který byl zabanován za zneužívání bugů hry,
          podvádění (jakýmikoliv způsobem) a griefing, vymazat inventář a
          zabavit veškerý majtek.
        </li>
        <ol>
          <li>
            Veškeré zabavené předměty jsou členové Admin Teamu povinni trvale
            zničit.
          </li>
      ...
      <h3 className="font-bold">B. Pravidla zeleného a fialového světa</h3>
      <ol>
        <li>
        ...
        <ol>
          <li>
            ...
            připojí jiný hráč, popřípadě více hráčů, jsou hráči, kteří dohodu
            uzavřeli povinni dané hráče upozornit na danou skutečnost, a to i
            klidně zpětně, nejdéle však 30minut po skončení souboje.
          </li>
          <li>
          ...
          <li>
            V takovém případě je hráč, nebo hráči, kteří nebyli původně zahrnuti
            v dohodě povinni vrátit účastníkům jejich věci, pokud tak neučiní
            jedná se o krádež! V opačném případě si může věci ponechat.
          </li>
          <li>
            Pokud Hráč číslo 1, který byl domluven na souboji s hráčem číslo2,
            zautočí na kohokoliv jiného, napadený hráč nemusí brát dohodu v
            potaz, a má právo se bránit!
          </li>
        </ol>
        <li>
        ...
        <ol>
          ...
          <li>
            ...
            zónami o sobě navzájem nevěděli, jsou povinni mezi sebou dospět k
            dohodě a stanovit si vlastní hranice nárokovaného území.
          </li>
          <li>
            V opačném případě a za předpokladu, že zde daní hráči pobývali delší
            dobu, danou hranici stanoví člen admin teamu.
          </li>
          <li>
            Pokud však jeden z hráčů strávil v dané zóně výrazně krátkou dobu a
            zároveň bude jedna strana odmítat dohodu, bude daný hráč vykázán bez
            nároku na náhradu škody tím způsobené!
          </li>
        </ol>
        <li>
          Hráč si nesmí bez povolení majitele objektu / pozemku nastavit lokaci
          „home“ na daném území!
        </li>
      </ol>

      <h3 className="font-bold">Pravidla PvP Arény</h3>
      <ol>
        <li>
          Je zakázáno používat Elytry, raketky, ender perly, chorus fruit, totem
          of undying a jakékoliv efekty uvnitř arény(to znamená i notch a golden
          apples)!
        </li>
        <li>
